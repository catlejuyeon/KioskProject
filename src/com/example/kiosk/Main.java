...
public class Main {
    public static void main(String[] args) {
        //버거 메뉴
        MenuItem shackBurger = new MenuItem(101,"ShackeBurger", 6900, "토마토, 양상추, 쉑소스가 토핑된 치즈버거");
        MenuItem smokeShack = new MenuItem(102,"SmokeShack", 8900, "베이컨, 체리 페퍼에 쉑소스가 토핑된 치즈버거");
        MenuItem cheeseBurger = new MenuItem(103,"Cheeseburger",6900,"포테이토 번과 비프패티, 치즈가 토핑된 치즈버거");
        MenuItem hamBurger = new MenuItem(104,"Hamburger", 5400, "비프패티를 기반으로 야채가 들어간 기본버거");
        ...
        //음료 메뉴
        MenuItem cokeZero = new MenuItem(201,"CokeZero", 3000, "설탕이 들어가 있지 않은 콜라");
        MenuItem americano = new MenuItem(202,"Americano", 4500, "정신 차려!하고 싶을 때~");
